  ...
  return (
    <header className="relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-16 pb-20">
        <div className={`inline-flex items-center gap-2 text-sm border rounded-full px-3 py-1 ${theme.accent.pill}`}>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          ...
          <a href="#services" className={`px-5 py-3 rounded-2xl border ${theme.accent.outline}`}>
            See services
          </a>
        </div>
      </div>
